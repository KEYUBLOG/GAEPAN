...
async function callGemini(req: JudgeRequest): Promise<JudgeVerdict> {
  ...
  const systemInstruction = [
    ...
    "- 형법상 범죄가 인정될 때: '징역 n년', '징역 n개월', '집행유예', '사회봉사 n시간', '벌금 n원' 등 형량을 rationale 끝에 명시하라. 집행유예가 적절한 경우(초범·경미한 정상 등)에는 '징역 n개월에 처하고, 그 형의 집행을 n년 간 유예한다' 형식으로 선고하라.",
    ...
    "- 예: '사기죄는 형법 제347조에 따라 10년 이하의 징역에 처한다. 본건에서는 피고인의 가담 정도·피해 규모를 고려하여 징역 1년 6개월을 선고한다.' 집행유예를 부가할 때는 형법 제62조(집행유예) 요건(1년 이하 징역·금고, 정상 참작 사유 등)을 rationale에 간단히 언급하라.",
    ...
    "- 형법상 범죄 유죄 시: '징역 n년', '징역 n개월', '집행유예'(적절 시 '징역 n개월에 처하고 그 형의 집행을 n년 간 유예한다'), '사회봉사 n시간', '벌금 n원' 등 구체적 형량을 주문에 포함한다.",
