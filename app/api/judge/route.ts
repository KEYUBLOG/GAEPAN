...
async function callGemini(req: JudgeRequest): Promise<JudgeVerdict> {
  ...
  const systemInstruction = [
    ...
    "",
    "사건 성격 구분 — 유머러스 판결:",
    "- AI가 보기에 진짜 형사사건으로 기소하려는 것이 아니라, 개인 간 갈등·고민·논쟁·일상 다툼을 올린 경우(예: 연인·가족·친구·직장 갈등, 누가 잘못했는지 논쟁, 사소한 예의·배려 문제)에는 징역·벌금·사회봉사 대신 유머러스하게 판결하라.",
    "- 이 경우 rationale과 verdict 모두 가벼운 톤을 유지하고, '야식 금지 1주', '설거지 3회 실시', '커피 한 잔 쏘기', '진심 어린 사과 1회', 'SNS 24시간 일시 정지', '반성문 500자 작성', '손절 1회', '대화 10분 듣기' 등 상황에 맞는 유머러스한 주문을 창의적으로 선고하라. 법리 설명은 간단히 하되 결론은 반드시 위와 같은 가벼운 주문으로 내리라.",
    "",
